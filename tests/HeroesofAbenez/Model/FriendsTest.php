...
final class FriendsTest extends \Tester\TestCase {
  ...
  public function setUp(): void {
    $this->model = $this->getService(Friends::class); // @phpstan-ignore assign.propertyType
  }
  
  public function testIsFriendsWith(): void {
  ...
  public function testBefriend(): void {
    ...
    /** @var \HeroesofAbenez\Orm\Request $request */

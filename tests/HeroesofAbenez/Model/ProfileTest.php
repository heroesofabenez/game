...
final class ProfileTest extends \Tester\TestCase {
  ...
  public function testGetRacesList(): void {
  ...
  public function testGetClassesList(): void {
  ...
  public function testGetAvailableSpecializations(): void {
  ...
  public function testGetStatPoints(): void {
    Assert::same(0, $this->model->getStatPoints());
  }

  public function testGetCharismaBonus(): void {
  ...
  public function testTrainStat(): void {
    $this->model->user = $this->getService(\Nette\Security\User::class); // @phpstan-ignore assign.propertyType
    Assert::exception(function() {

...
final class RequestTest extends \Tester\TestCase
{
    ...
    {
        $this->model = $this->getService(Request::class); // @phpstan-ignore assign.propertyType
    }
    ...
    public function testCanShow(): void
    {
        ...
        $request->from = $orm->characters->getById(2); // @phpstan-ignore assign.propertyType
        $request->to = $this->getCharacter();
        Assert::true($this->model->canShow($request));
        $request->to = $orm->characters->getById(2); // @phpstan-ignore assign.propertyType
        ...
        $request->from = $orm->characters->getById(2); // @phpstan-ignore assign.propertyType
        Assert::true($this->model->canShow($request));
        $request->from = $orm->characters->getById(4); // @phpstan-ignore assign.propertyType
        Assert::false($this->model->canShow($request));
        ...
        $request->to = $this->getCharacter();
        Assert::true($this->model->canShow($request));
        $request->to = $orm->characters->getById(4); // @phpstan-ignore assign.propertyType
        Assert::false($this->model->canShow($request));
    ...
    public function testCanChange(): void
    {
        ...
        $request->from = $orm->characters->getById(3); // @phpstan-ignore assign.propertyType
        $request->to = $this->getCharacter();
    ...
    public function testListOfRequest(): void
    {
        /** @var \HeroesofAbenez\Orm\Model $orm */
        $orm = $this->getService(\HeroesofAbenez\Orm\Model::class);
        ...
        $request1->to = $orm->characters->getById(2); // @phpstan-ignore assign.propertyType
        ...
        $request2->from = $orm->characters->getById(2); // @phpstan-ignore assign.propertyType
        ...
        $request3->to = $orm->characters->getById(2); // @phpstan-ignore assign.propertyType
        ...
        $request4->from = $orm->characters->getById(2); // @phpstan-ignore assign.propertyType

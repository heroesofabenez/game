...
INSERT INTO `quests` (`id`, `name`, `introduction`, `end_text`, `cost_money`, `needed_item`, `needed_quest`, `needed_level`, `item_amount`, `item_lose`, `reward_money`, `reward_xp`, `reward_item`, `reward_white_karma`, `reward_dark_karma`, `reward_pet`, `npc_start`, `npc_end`, `order`) VALUES
  (1,	'Find a book',	'To continue in your training, you need to get book ABC. Ask the librarian about it.',	'Well done, my apprentice.',	0,	1,	NULL,	NULL,	1,	0,	0,	10,	NULL, 0, 0, NULL,	1,	1,	1);
...
INSERT INTO `npcs` (`id`, `name`, `description`, `race`, `type`, `sprite`, `portrait`, `stage`, `karma`, `personality`, `level`, `pos_x`, `pos_y`) VALUES
  (1,	'Mentor',	'He\'s quite old for a human.',	2,	'quest',	'mentor.jpeg',	'mentor.jpeg',	1,	'neutral', 'teaching', 10,	1,	1),
  (2,	'Librarian',	'She look like a typical middle-aged female librarian. She sells books for wizards.',	2,	'shop',	'librarian.jpeg',	'librarian.jpeg',	3,	'neutral', 'friendly', 10,	1,	1);

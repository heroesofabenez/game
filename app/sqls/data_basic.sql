...
INSERT INTO `pve_arena_opponents` (`id`, `name`, `race`, `gender`, `occupation`, `level`, `strength`, `dexterity`, `constitution`, `intelligence`, `charisma`, `weapon`, `armor`) VALUES
  (1,	'Div Fast-hands',	2,	'male',	2,	2,	11,	13,	8,	10,	10,	4,	9),
  (2,	'El-Tovil',	4,	'male',	1,	2,	13,	9,	14,	8,	8,	3,	8),
  (3,	'Valiana',	3,	'female',	3,	2,	8,	11,	7,	15,	13,	6,	10),
  (4,	'Alinia',	3,	'female',	4,	3,	8,	14,	8,	12,	12,	7,	11),
  (5,	'Eldan',	1,	'male',	1,	5,	13,	10,	15,	8,	8,	2,	8);

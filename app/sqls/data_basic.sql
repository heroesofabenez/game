...
INSERT INTO `pve_arena_opponents` (`id`, `name`, `race`, `gender`, `occupation`, `level`, `weapon`, `armor`) VALUES
  (1,	'Div Fast-hands',	2,	'male',	2,	2,	4,	9),
  (2,	'El-Tovil',	4,	'male',	1,	2,	3,	8),
  (3,	'Valiana',	3,	'female',	3,	2,	6,	10),
  (4,	'Alinia',	3,	'female',	4,	3,	7,	11),

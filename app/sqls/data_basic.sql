...
INSERT INTO `npcs` (`id`, `name`, `description`, `race`, `type`, `sprite`, `portrait`, `stage`, `karma`, `personality`, `pos_x`, `pos_y`) VALUES
  (1,	'Mentor',	'He\'s quite old for a human.',	2,	'quest',	'mentor.jpeg',	'mentor.jpeg',	1,	'neutral', 'friendly',	1,	1),
  (2,	'Librarian',	'She look like a typical middle-aged female librarian. She sells books for wizards.',	2,	'shop',	'librarian.jpeg',	'librarian.jpeg',	3,	'neutral', 'friendly',	1,	1);

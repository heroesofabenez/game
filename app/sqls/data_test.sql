...
INSERT INTO `characters` (`id`, `name`, `race`, `gender`, `class`, `specialization`, `level`, `money`, `experience`, `strength`, `dexterity`, `constitution`, `intelligence`, `charisma`, `guild`, `guildrank`, `owner`, `current_stage`, `white_karma`, `dark_karma`, `intro`, `joined`, `last_active`, `stat_points`, `skill_points`) VALUES
(1,	'James The Invisible',	2,	'male',	3,	NULL,	3,	159,	143,	9,	10.2,	10.2,	14,	11.5,	1,	7,	1,	1,	0,	0,	2,	'2015-05-10 13:42:10',	'2019-01-13 15:43:46',	0.05,	0),
(2,	'Ilivia',	3,	'female',	2,	NULL,	1,	0,	0,	10,	13,	6,	11,	12,	1,	1,	1,	1,	0,	0,	1,	'2015-05-10 13:42:10',	'2015-05-10 13:42:10',	0,	0),
(3,	'Amanda',	2,	'female',	3,	NULL,	1,	0,	0,	9,	10,	9,	12,	11,	2,	7,	0,	1,	0,	0,	2,	'2015-05-10 14:32:22',	'2015-05-10 14:32:22',	0,	0),
(4,	'Alvid',	3,	'male',	1,	NULL,	1,	0,	0,	10,	11,	10,	10,	11,	3,	7,	0,	1,	0,	0,	2,	'2015-05-12 17:47:55',	'2015-05-12 17:47:55',	0,	0);

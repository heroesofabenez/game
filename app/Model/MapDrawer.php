...
{
    public function __construct(private readonly Location $locationModel, private readonly \Nette\Security\User $user, private readonly ILoader $loader, private readonly ApplicationDirectories $directories)
    {
    }
